...
import { bytesToSize, convertFile, compressFileName, loadFfmpeg } from '@/lib/utils'
    ...
    return (
      <div className="space-y-6">
        {actions.map((action: Action, i: any) => (
          ...
          >
            {!is_loaded && <Skeleton className="h-full w-full -ml-10 cursor-progress absolute rounded-xl" />}
  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps }) => (
        <div
          {...getRootProps()}
          className="w-full bg-background h-72 lg:h-80 xl:h-96 rounded-3xl shadow-sm border-secondary border-2 border-dashed cursor-pointer flex items-center justify-center"
        >
          <input {...getInputProps()} />
